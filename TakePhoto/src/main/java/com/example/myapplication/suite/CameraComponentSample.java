 ...
 * @author Clear
 */
public class CameraComponentSample extends SampleBase
		implements TuCameraFragmentDelegate
{
	/**
	 * 范例分组头部信息
	 *
	 ...
	 * @param titleResId
	 */
//	public CameraComponentSample(GroupType groupId, int titleResId) {
...
//相机左下角会显示相册入口，当点击该入口的时候程序会自动调用 onTuAlbumDemand() 方法，
// 需要自己在该方法中实现跳转到相册的处理逻辑
